cp \
  ...
  /usr/x86_64-w64-mingw32/sys-root/mingw/bin/icu*.dll \
  ...
  /usr/x86_64-w64-mingw32/sys-root/mingw/bin/libboost_python39-mt-x64.dll \
  ...
  /usr/x86_64-w64-mingw32/sys-root/mingw/bin/libdl.dll \
  ...
  /usr/x86_64-w64-mingw32/sys-root/mingw/bin/libpython3.9.dll \
